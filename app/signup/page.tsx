    ...
    <div className="relative flex min-h-svh font-display">
      ...
      <div className="relative flex flex-1 flex-col bg-[#05021a]">
        ...
        <div className="pointer-events-none absolute inset-0 lg:hidden">
          <div className="absolute -top-20 left-0 h-[300px] w-[300px] rounded-full bg-purple-600/10 blur-[120px]" />
          <div className="absolute bottom-0 right-0 h-[250px] w-[250px] rounded-full bg-violet-500/8 blur-[100px]" />
        </div>
      ...
      <div className="relative hidden w-[52%] overflow-hidden bg-[#08021f] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-40 right-0 h-[500px] w-[500px] rounded-full bg-purple-600/15 blur-[160px]" />
          <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-violet-500/10 blur-[140px]" />
          <div className="absolute top-1/2 right-1/3 h-[300px] w-[300px] rounded-full bg-fuchsia-600/8 blur-[120px]" />
        </div>
        ...
        <div className="pointer-events-none absolute inset-0 opacity-[0.03]">
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="signup-hex" width="56" height="100" patternUnits="userSpaceOnUse" patternTransform="scale(1.2)">
                <path d="M28 66L0 50L0 16L28 0L56 16L56 50L28 66L28 100" fill="none" stroke="#a78bfa" strokeWidth="0.4" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#signup-hex)" />
          </svg>
        </div>
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between p-12 xl:p-16">
          ...
          <div className="max-w-md self-end text-right">
            ...
            <p className="mt-5 text-base leading-relaxed text-purple-200/50">
              Create your account and start browsing premium verified social media logs with instant delivery.
            </p>
          </div>
